...
**Stream WebRTC Android** is Google's WebRTC pre-compiled library for Android. It reflects the recent WebRTC updates to facilitate real-time video chat using functional UI components, Kotlin extensions for Android, and Compose.
